...
if (isset($_GET["satisdurum"]))			{$satisdurum=$_GET["satisdurum"];}
	elseif (isset($_POST["satisdurum"]))	{$satisdurum=$_POST["satisdurum"];}
...
if (isset($_GET["onay"]))			{$onay=$_GET["onay"];}
	elseif (isset($_POST["onay"]))	{$onay=$_POST["onay"];}
...
if ($ACTION == 'AGENTSview')
	...
	echo "</TABLE><BR>\n";
	echo "<font style=\"font-size:10px;font-family:sans-serif;\"><font style=\"background-color:#ADD8E6;\"> &nbsp; &nbsp;</font>-"._QXZ("WAITING")." &nbsp; <font style=\"background-color:#D8BFD8;\">&nbsp; &nbsp;</font>-"._QXZ("SPRECHEN")." &nbsp; <font style=\"background-color:#F0E68C;\"> &nbsp; &nbsp;</font>-"._QXZ("BREAK")." &nbsp;\n";
	if (preg_match("/NOT-LOGGED-IN-AGENTS/",$agent_status_viewable_groups))
		{echo "<font style=\"background-color:#FFFFFF;\"> &nbsp; &nbsp;</font>"._QXZ("-AUSGABE")." &nbsp;\n";}
...
if ($ACTION == 'CALLSINQUEUEview')
	...
	if (preg_match('/NONE/i',$view_calls_in_queue))
		{
		echo _QXZ("Anrufe in Warteschlangenansicht Für diese Kampagne deaktiviert")."\n";
		if ($SSagent_debug_logging > 0) {vicidial_ajax_log($NOW_TIME,$startMS,$link,$ACTION,$php_script,$user,$stage,$lead_id,$session_name,$stmt);}
		exit;
		}
	else
		...
		echo "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=90%>";
		echo "<TR>";
		echo "<TD> &nbsp; </TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TELEFON")." &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("VORNAME")." &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("WAITING")." &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("NUTZER")." &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"> &nbsp; &nbsp; &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("GROUP")." &nbsp; </font></TD>";
		echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TYP")." &nbsp; </font></TD>";
		echo "</TR>";
		...
		while ( ($calls_count > $loop_count) and ($view_calls_in_queue > $loop_count) )
			...
			if ( (preg_match('/Y/i',$grab_calls_in_queue)) and ($OQcall_type[$loop_count]=='IN') )
				{
				echo "<TR $Qcolor>";
				echo "<TD> <a href=\"#\" onclick=\"callinqueuegrab('$OQauto_call_id[$loop_count]');return false;\"><font style=\"font-size: 11px; font-family: sans-serif;\">"._QXZ("ANNEHMEN")."</a> &nbsp; </TD>";
...
if ($ACTION == 'CALLLOGview')
	...
	$checkSql="";
if($satisdurum=='var'){$checkSql="checked=\"checked\"";}
	echo "<div class=\"card col-md-12\"><div class=\"card-header\"><h3 class=\"card-title\"></h3></div> <div class=\"card-body\"  style=\"flex: 0.5 0.5 auto; padding: 0.5rem;\">";
	...
	echo "<input type=\"checkbox\" id=\"satis\" onChange=\"VieWCalLLoG('','form');return false;\" $checkSql/> Nur Verkauf&nbsp; &nbsp; ";
	if ($NOW_DATE != $date)
		{echo "<a href=\"#\" onclick=\"VieWCalLLoG('$next_day_date','');return false;\"> $next_day_date > </a> &nbsp; &nbsp; ";}
	echo "<input type=text name=calllogdate id=calllogdate value=\"$date\" class=\"form-control\" style=\"width:90px;height:25px; font-family:Arial, Helvetica, sans-serif; font-size:10px;\" size=12 maxlength=10><br><br>";
	...
	echo "</div></div>\n";
	echo "<BR>\n";
	echo "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=\"100%\" class=\"table \" >";
	echo "<TR height=\"20px;\">";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("DATUM")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ZEIT")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("STATUS")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TELEFON")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("VORNAME")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("KAMPAGNE")." &nbsp; </font></TD>";
	//echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("METHOD")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("NIEDER")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("SCHLIESSEN")." &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp;  &nbsp; </font></TD>";
	echo "<TD class=\"bg-dark text-white\" width=\"#150px\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp;  &nbsp; </font></TD>";
	echo "</TR>";
$satisSql="";
if($satisdurum=='var'){$satisSql=" and status='SALE'";}
	$stmt="SELECT start_epoch,call_date,campaign_id,length_in_sec,status,phone_code,phone_number,lead_id,term_reason,alt_dial,comments from vicidial_log where user='$user' and call_date >= '$date 0:00:00'  and call_date <= '$date 23:59:59' $satisSql ORDER BY call_date DESC limit 10000;";
	$rslt=mysql_to_mysqli($stmt, $link);
	...
	$stmt="SELECT start_epoch,call_date,campaign_id,length_in_sec,status,phone_code,phone_number,lead_id,term_reason,queue_seconds from vicidial_closer_log where user='$user' and call_date >= '$date 0:00:00'  and call_date <= '$date 23:59:59' $satisSql ORDER BY closecallid DESC limit 10000;";
	$rslt=mysql_to_mysqli($stmt, $link);
	...
	if ($g > 0)
		...
		{echo "<tr bgcolor=white><td colspan=11 align=center>"._QXZ("Keine Anruflisten gefunden")."</td></tr>";}
	...
	while ($g > $u) 
		...
		$u++;
		echo "<tr $bgcolor height=\"20px;\">";
		
		echo "<td align=right><font style='font-size:9px;'>$ALLcall_date[$i]</td>";
		echo "<td align=right><font style='font-size:9px;'> $ALLlength_in_sec[$i]</td>\n";
		echo "<td align=right><font style='font-size:9px;'> $ALLstatus[$i]</td>\n";
		echo "<td align=right><font style='font-size:9px;'> $ALLphone_code[$i] $phone_number_display </td>\n";
		echo "<td align=right><font style='font-size:9px;'> $Allfirst_name[$i] $Alllast_name[$i] </td>\n";
		echo "<td align=right><font style='font-size:9px;'> $ALLcampaign_id[$i] </td>\n";
		//echo "<td align=right><font style='font-size:9px;'> $ALLin_out[$i] </td>\n";
		echo "<td align=right><font style='font-size:9px;'> $ALLalt_dial[$i] </td>\n";
		echo "<td align=right><font style='font-size:9px;'> $ALLhangup_reason[$i] </td>\n";
		echo "<td align=left><a href=\"#\" onclick=\"VieWLeaDInfO($ALLlead_id[$i]);return false;\" class=\"btn btn-block btn-info btn-sm\"><i class=\"fa fa-info-circle\" aria-hidden=\"true\"></i></A> </td>\n";
		if ($manual_dial_filter > 0)
			{echo "<td align=left ><a href=\"#\" onclick=\"NeWManuaLDiaLCalL('CALLLOG','$ALLphone_code[$i]','$ALLphone_number[$i]','$ALLlead_id[$i]','','YES');return false;\" class=\"btn btn-block btn-success btn-sm\"> <i class=\"fa fa-phone\" aria-hidden=\"true\"></i></A> </td>\n";}
		else
			{echo "<td align=left><font class='sb_text'><i class=\"fa fa-phone\" aria-hidden=\"true\"></i></A></td>\n";}
		echo "</tr>\n";
		}

	echo "</TABLE>";
	echo "<BR>";
	echo "<a href=\"#\" onclick=\"CalLLoGVieWClose();return false;\" class=\"btn btn-dark btn-small\"><i class=\"fa fa-times\" aria-hidden=\"true\"></i></a>";
	echo "</CENTER>";
	}
...
if ($ACTION == 'SEARCHRESULTSview')
	...
	if ($camps_to_print > 0) 
		...
		elseif (strlen($last_name) > 0)
			...
			{
			echo "ERROR: "._QXZ("Arama terimleri girmelisiniz, bunlardan biri doldurulmalıdır: Müşteri No, Personel, telefon numarası, Soyadı")."\n";
			echo "<BR><BR>";
			echo "<a href=\"#\" onclick=\"hideDiv('SearcHResultSDisplaYBox');return false;\">"._QXZ("Geri Dön")."</a>";
			echo "</CENTER>";
			if ($SSagent_debug_logging > 0) {vicidial_ajax_log($NOW_TIME,$startMS,$link,$ACTION,$php_script,$user,$stage,$lead_id,$session_name,$stmt);}
			exit;
			}
		...
		if ($counts_to_print > 0) 
			...
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ADI SOYADI")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TELEFON")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("DURUM")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("SON GÖRÜŞME")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ŞEHİR")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("SEMT")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("POSTAKODU")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("SATICI")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("BİLGİ")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ARA")." &nbsp; </font></TD>";
			echo "</TR>";
			...
			if ($search_result_count)
				...
				if ($g < 1)
					{echo "<tr bgcolor=white><td colspan=10 align=center><font class='sh_text'>"._QXZ("Veri Kaydı Bulunamadı")."</font></td></tr>";}
				...
				while ($g > $u) 
					...
					echo "<td align=right><font class=\"sb_text\"> <a href=\"#\" onclick=\"VieWLeaDInfO($ALLlead_id[$i],'','$inbound_lead_search');return false;\"> "._QXZ("BİLGİ")." </A> </font></td>\n";
					if ($inbound_lead_search < 1)
						{
						if ($manual_dial_filter > 0)
							{echo "<td align=right><font class=\"sb_text\"> <a href=\"#\" onclick=\"NeWManuaLDiaLCalL('LEADSEARCH','$ALLphone_code[$i]','$ALLphone_number[$i]','$ALLlead_id[$i]','','YES');return false;\"> "._QXZ("ARA")." </A> </font></td>\n";}
						else
							{echo "<td align=right><font class=\"sb_text\"> "._QXZ("ARA")." </font></td>\n";}
						}
					else
						{
			...
			echo "</TABLE>";
			echo "<BR>";
			echo "<a href=\"#\" onclick=\"hideDiv('SearcHResultSDisplaYBox');return false;\">"._QXZ("GERİ DÖN")."</a>";
			echo "</CENTER>";
			}
		else
			{
...
if ($ACTION == 'LEADINFOview')
	...
	#		$INFOout .= "<tr bgcolor=white><td ALIGN=right><font class='sb_text'>Entry List ID: &nbsp; </td><td ALIGN=left><font class='sb_text'>$row[28]</td></tr>";
		...
		#	$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\" COLSPAN=9><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; FULL NAME &nbsp; </font></TD>";
			...
			$stmt="SELECT start_epoch,call_date,campaign_id,length_in_sec,status,phone_code,phone_number,lead_id,term_reason,alt_dial,comments,uniqueid,user from vicidial_log where lead_id='$lead_id' and user='$user' order by call_date desc limit 10000;";
			$rslt=mysql_to_mysqli($stmt, $link);
			...
			$stmt="SELECT start_epoch,call_date,campaign_id,length_in_sec,status,phone_code,phone_number,lead_id,term_reason,queue_seconds,uniqueid,closecallid,user from vicidial_closer_log where lead_id='$lead_id' and user='$user' order by closecallid desc limit 10000;";
			$rslt=mysql_to_mysqli($stmt, $link);
...
$start_time = date('Y-m-d');
	...
	$checkSql_bekletilen="";
	$checkSql_redler="";
	if($onay==''){$checkSql="checked=\"checked\""; $onaySql="";}
	if($onay=='1'){$checkSql_onayli="checked=\"checked\""; $onaySql=" and onay='1' ";}
	if($onay=='0'){$checkSql_bekleyen="checked=\"checked\""; $onaySql=" and onay='0' ";}
	if($onay=='2'){$checkSql_bekletilen="checked=\"checked\""; $onaySql=" and onay='2' ";}
	if($onay=='3'){$checkSql_redler="checked=\"checked\""; $onaySql=" and onay='3' ";}
	$NOTESout .="<div class=\"card col-md-12\"><div class=\"card-header\"><h3 class=\"card-title\">".$start_time." ".$end_time." Zwischen Daten abgefragt</h3></div> <div class=\"card-body\"  style=\"flex: 0.5 0.5 auto; padding: 0.5rem;\">";
            
              
  
	$NOTESout .="<input type=\"date\" id=\"start_time\" value=\"$start_time\"/>Start &nbsp; &nbsp; ";
	$NOTESout .="<input type=\"date\" id=\"end_time\" value=\"$end_time\"/> Finish&nbsp; &nbsp; ";
	$NOTESout .="<input type=\"radio\" name=\"onay\" id=\"onay1\" value=\"2\" $checkSql_bekletilen/>Ausstehend&nbsp; &nbsp; ";
	$NOTESout .="<input type=\"radio\" name=\"onay\" id=\"onay2\" value=\"1\" $checkSql_onayli />akzeptieren&nbsp; &nbsp; ";
	$NOTESout .="<input type=\"radio\" name=\"onay\" id=\"onay3\" value=\"0\" $checkSql_bekleyen/>Unverarbeitet&nbsp; &nbsp; ";
	$NOTESout .="<input type=\"radio\" name=\"onay\" id=\"onay4\" value=\"3\" $checkSql_redler />Abgelehnt&nbsp; &nbsp;&nbsp; &nbsp; ";
	$NOTESout .="<input type=\"radio\" name=\"onay\" id=\"onay5\" value=\"\" $checkSql />alle&nbsp; &nbsp; ";
	$NOTESout .="<a href=\"#\" onclick=\"satislarim();return false;\"  class=\"btn-ass\"><i class=\"fa fa-hand-o-left\" aria-hidden=\"true\"></i>"._QXZ("LISTEN")."</a> &nbsp;  &nbsp; &nbsp; ";
	$NOTESout .="<br><br>";
	$NOTESout .="</B></font></div></div>\n";
	$NOTESout .="<BR>\n";
	
	
	
	
		$stmt="select first_name, last_name, tel,onay,event_time from A_ozel_tablo where event_time >= '".$start_time." 00:00:00' and event_time<='".$end_time." 23:59:59' and user='".$user."' $onaySql";
			...
			$NOTESout .= "<CENTER>"._QXZ("Meine SALES:")."<br>\n";
			$NOTESout .= "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=80% style=\"margin-right:10%;\">";
			$NOTESout .= "<TR>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; # &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("VORNAME")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("NAME")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TELEFON")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("DATUM")." &nbsp; </font></TD>";
			...
			while ($in_logs_to_print > $u) 
				...
				$row=mysqli_fetch_row($rslt);
						...
						if($row[3]=='1'){$bgcolor='bgcolor="#008000"';}
						if($row[3]=='2'){$bgcolor='bgcolor="#FFD700"';}
						if($row[3]=='3'){$bgcolor='bgcolor="#FF0000"';}
				        if($row[3]=='4'){$bgcolor='bgcolor="#FF8C00"';}
				        if($row[3]=='5'){$bgcolor='bgcolor="#000"';}
				
					
				
					$NOTESout .= "<TR $bgcolor>";
					$NOTESout .= "<TD>".$u."</TD>";
					$NOTESout .= "<TD>".$row[0]."</TD>";
					$NOTESout .= "<TD>".$row[1]."</TD>";
					$NOTESout .= "<TD>".$row[2]."</TD>";
					$NOTESout .= "<TD>".$row[4]."</TD>";
...
### lİSTEDEN kALDIR
################################################################################
	if ($ACTION == 'listedenkaldirmazorla')
	{
	$stmt="update vicidial_agent_log  setevent_time='$NOW_TIME' where lead_id='$lead_id' order by agent_log_id desc limit 1;";
			if ($DB) {echo "$stmt\n";}
			$rslt=mysql_to_mysqli($stmt, $link);
	}		
##########
...
### lİSTEDEN kALDIR
################################################################################
	if ($ACTION == 'listedenkaldir')
	{
	$stmt="update vicidial_agent_log (user,server_ip,event_time,campaign_id,pause_epoch,pause_sec,wait_epoch,user_group,sub_status,pause_type,lead_id) values('$user','$server_ip','$NOW_TIME','$campaign','$StarTtime','0','$StarTtime','$user_group','SİL','AGENT','$lead_id');";
			if ($DB) {echo "$stmt\n";}
			$rslt=mysql_to_mysqli($stmt, $link);
	}		
################################################################################
...
if ($ACTION == 'kacancagrilar')
	{
		
$stmtlis = "SELECT list_id from vicidial_lists where campaign_id='".trim($campaign)."';";
		$rsltlis=mysql_to_mysqli($stmtlis, $link);
		$cs_ctlis = mysqli_num_rows($rsltlis);
		$a=0;
		$list_Sql=" and vcl.list_id IN(";
		while ($cs_ctlis > $a)
			{
				$rowlis=mysqli_fetch_row($rsltlis);
				if($a>0){$list_Sql.=",";}
			$list_Sql.="'".$rowlis[0]."'";
			$a++;
			}
...
$closer_camp="";
		$stmt_closer="Select closer_campaigns from vicidial_campaigns Where campaign_id='".trim($campaign)."'";
			$rslt_closer=mysql_to_mysqli($stmt_closer, $link);
				if ($mel > 0) {mysql_error_logging($NOW_TIME,$link,$mel,$stmt_closer,'00583',$user,$server_ip,$session_name,$one_mysql_log);}
			$in_stmt_closer = mysqli_num_rows($rslt_closer);
			
			$a=0;
			while ($in_stmt_closer > $a) 
				{
				$row_closer=mysqli_fetch_row($rslt_closer);
				$closer_camp=$row_closer[0];
		
				$a++;
				}
		$closer_camp_sql="";
		$LOGallowed_closerSQL ="";
		if ( (!preg_match('/\-ALL/i', $closer_camp)) )
	{
	$closer_camp_sql = preg_replace("/ -/",'',$closer_camp);
	$closer_camp_sql = preg_replace("/ /","','",$closer_camp_sql);
	$LOGallowed_closerSQL = " and campaign_id IN('$closer_camp_sql')";
...
//c.status=v.status 
	...
	$stmt="SELECT vdl.caller_id_number, vcl.call_date, vdl.extension, vcl.lead_id
FROM vicidial_did_log vdl, call_log cl, vicidial_closer_log vcl, vicidial_list vl
WHERE vdl.extension IN('$closer_camp_sql')
AND vcl.call_date > DATE_SUB( CURDATE( ) , INTERVAL 2 
DAY )
AND vdl.uniqueid = cl.uniqueid
AND vcl.uniqueid = cl.uniqueid
$list_Sql
AND vcl.status IN('DROP','AFTHRS','TIMEOT','NANQUE')
AND cl.end_time IS NOT NULL
AND vcl.call_date=(SELECT MAX(vcl.call_date))
AND vl.lead_id=vcl.lead_id
Group By vdl.caller_id_number
order by vcl.closecallid desc";
	
	
		//$stmt="SELECT phone_number,length_in_sec, call_date,campaign_id,lead_id, list_id from  vicidial_closer_log WHERE  status IN('DROP','AFTHRS','TIMEOT','NANQUE')".$LOGallowed_closerSQL."".$list_Sql." and call_date >= DATE_SUB(CURDATE(), INTERVAL 5 DAY) GROUP BY lead_id ORDER BY closecallid DESC";
			$rslt=mysql_to_mysqli($stmt, $link);		
			...
			$u=0;
			$a=1;
			$NOTESout .= "<CENTER>"._QXZ("PRIORITÄTSANRUFE:")."<br>\n";
			$NOTESout .= "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=90%>";
			$NOTESout .= "<TR>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; # &nbsp; </font></TD>"
			
			;$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ANGERUFENE")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ANRUFER")." &nbsp; </font></TD>";
			
			
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("UNZUGäNGLICH")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("LETZTES DATUM")." &nbsp; </font></TD>";
			
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\" COLSPAN=6><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("PROZESS")." &nbsp; </font></TD>";
			$NOTESout .= "</TR>";
			...
			while ($in_logs_to_print > $u) 
				{
				 	$row=mysqli_fetch_row($rslt);
						...
						$stmtcloser="SELECT call_date, campaign_id from vicidial_closer_log  WHERE lead_id='".trim($row[3])."' ORDER BY closecallid DESC limit 1";
					$rsltkloser=mysql_to_mysqli($stmtcloser, $link);
					$kloser=mysqli_fetch_row($rsltkloser);
					$klosertar=trim($kloser[0]);
				$kloserno=trim($kloser[1]);
				
					
						$stmtk="SELECT event_time from vicidial_agent_log  WHERE lead_id='".trim($row[3])."' ORDER BY agent_log_id DESC limit 1";
					$rsltk=mysql_to_mysqli($stmtk, $link);
					$k = mysqli_num_rows($rsltk);
					$ks=mysqli_fetch_row($rsltk);
					$sattar=trim($ks[0]);
					
					
					
					
				if(($k>0 && date('Y-m-d H:i:s', strtotime($klosertar)) > date('Y-m-d H:i:s', strtotime($sattar))) ||  ($k==0))
				{
					
					if($row[0]!='anonymous')
					{
					
				if (preg_match("/1$|3$|5$|7$|9$/i", $a))
					{$bgcolor='bgcolor="#B9CBFD"';} 
				else
					{$bgcolor='bgcolor="#9BB9FB"';}
					$NOTESout .= "<TR $bgcolor>";
					$NOTESout .= "<TD>$a</TD>";
					$NOTESout .= "<TD>".$kloserno."</TD>";
					$NOTESout .= "<TD>".$row[0]."</TD>";
					$NOTESout .= "<TD>".$klosertar."</TD>";
					$NOTESout .= "<TD>".$sattar."</TD>";
					
					$NOTESout .= "<TD><a href=\"#\" onclick=\"OncelikliNeWManuaLDiaLCalLSubmiT('NOW','YES','".trim($row[3])."')\" class=\"btn btn-block btn-success btn-sm\"><i class=\"fa fa-phone\" aria-hidden=\"true\"></i></a></TD>";
					
					$NOTESout .= "<TD><a href=\"#\" onclick=\"listedenkaldir( '".trim($row[3])."')\" class=\"btn btn-block btn-danger btn-sm\"><i class=\"fa fa-trash\" aria-hidden=\"true\"></i></a></TD>";
	...
	################################################################################
###kacan cagri sayisi Sorgula
################################################################################
	if ($ACTION == 'kacancagrisayisi')
	{
			...
			while ($in_logs_to_print > $u) 
				{
					...
					$stmtcloser="SELECT call_date from vicidial_closer_log  WHERE lead_id='".trim($row[3])."' ORDER BY closecallid DESC limit 1";
					$rsltkloser=mysql_to_mysqli($stmtcloser, $link);
					$kloser=mysqli_fetch_row($rsltkloser);
					$klosertar=trim($kloser[0]);
...
##### Yeni Müşteri Ekleme  #####
if ($ACTION == 'yenimusteriKaydet')
	{
		$stmtlis = "SELECT list_id from vicidial_lists where campaign_id='$campaign';";
		$rsltlis=mysql_to_mysqli($stmtlis, $link);
		$cs_ctlis = mysqli_num_rows($rsltlis);
		$a=0;
		$list_Sql=" and list_id IN(";
		while ($cs_ctlis > $a)
			{
				$rowlis=mysqli_fetch_row($rsltlis);
				if($a>0){$list_Sql.=",";}
		...
		$stmt = "SELECT phone_number,list_id from vicidial_list where phone_number='$phone_number'$list_Sql;";
		if ($DB) {echo "$stmt\n";}
		$rslt=mysql_to_mysqli($stmt, $link);
		...
		if($cs_ct >0){
			...
			echo "Bu Telefon Numarası Kampanya Listelerinde Mevcut<br>Telefon Numarasını Kullanabilirsiniz";
		}else{
			
			
	$stmt = "INSERT INTO vicidial_list SET list_id='$list_id',title='$title',phone_number='$phone_number',first_name='$first_name',last_name='$last_name';";
	$rslt=mysql_to_mysqli($stmt, $link);
	
	
					$dbismi="custom_".$list_id;
					$ed_sql="SELECT table_name FROM information_schema.tables WHERE table_schema =  'asterisk'
AND table_name =  '".$dbismi."';";
					
					$rsltkontrol=mysql_to_mysqli($ed_sql, $link);				 
					if (!$rsltkontrol) 
					{
						...
						$stmtson = "SELECT lead_id from vicidial_list where phone_number='$phone_number' and list_id='$list_id';";
						$se.=$stmtson;
						if ($DB) {echo "$stmtson\n";}
						$rsltson=mysql_to_mysqli($stmtson, $link);
						$cs_ctson = mysqli_num_rows($rsltson);
						$say=0;
						while($cs_ctson > $say)
						{
						$rowson=mysqli_fetch_row($rsltson);	
						$yenimusno=$rowson[0];
						$say++;
						}
						
					$stmtozlist = "INSERT INTO ".$dbismi." SET lead_id='$yenimusno';";
					$rsltozlist=mysql_to_mysqli($stmtozlist, $link);
	...
	echo "Kayıt Yapıldı Şimdi Telefon Numarasını Kullanabilirsiniz";
			}
...
if ($ACTION == 'TOPON')
	{
		...
		$stmtson = "SELECT user from A_storno where tarih ='$NOW_DATE' and user ='$user';";
		$rsltson=mysql_to_mysqli($stmtson, $link);
		$cs_ctson = mysqli_num_rows($rsltson);
		if($cs_ctson<1)
		{
		$stmt="UPDATE A_storno SET storno_sayisi='0', tarih ='$NOW_DATE' where user ='$user';";
		$rslt=mysql_to_mysqli($stmt, $link);
		}
	
	$sonuc='';	
	
	$stmtlisteler="SELECT val.user,count(val.user)as satis,ast.storno_sayisi as storno,COUNT( val.user ) - ast.storno_sayisi AS kalan
FROM A_storno AS ast, vicidial_agent_log AS val WHERE val.campaign_id='$campaign' and val.user = ast.user AND DATE_FORMAT( val.event_time,  '%Y-%m-%d' ) =  '$NOW_DATE' AND ast.tarih ='$NOW_DATE' AND val.status ='SALE' GROUP BY val.user ORDER BY kalan DESC";
	
	//$stmtlisteler="SELECT val.user,count(*) FROM vicidial_agent_log as val WHERE val.campaign_id='$campaign' and val.date_format(event_time,'%Y-%m-%d')='$NOW_DATE' and val.status='SALE' group by val.user order by count(*) desc";
	$rsltlisteler=mysql_to_mysqli($stmtlisteler, $link);
	$listesayisi = mysqli_num_rows($rsltlisteler);
	$stmts="SELECT count(*) FROM vicidial_agent_log WHERE campaign_id='$campaign' and date_format(event_time,'%Y-%m-%d')='$NOW_DATE' and status='SALE'";
	$rslts=mysql_to_mysqli($stmts, $link);
	$rows=mysqli_fetch_row($rslts);
	$satissayisi=$rows[0];
	$as=0;	
	
			$sonuc.='<tr><th>AGENT</th><th>VERKAUF</th><th>STORNO</th><th>ERGEBNIS</th></tr>';
	while ($as<$listesayisi) 
		{
			$seymbol='';
			$rowliste=mysqli_fetch_row($rsltlisteler);
			if($satissayisi>0){
							
						if($as==0 && $rowliste[1]>0 ){$seymbol='fa-trophy';}
						else if(($as==1 || $as==2)&& $rowliste[1]>0){$seymbol='fa-thumbs-up';}
						else if($as>2){$seymbol='fa-frown-o';}
						else{$seymbol='fa-meh-o';}
						}else{$seymbol='fa-meh-o';}
  			
			$stmtu="SELECT full_name FROM vicidial_users WHERE user='".$rowliste[0]."' limit 1";
			$rsltu=mysql_to_mysqli($stmtu, $link);
			$rowu=mysqli_fetch_row($rsltu);
			$sonuc.='<tr><td align="left" style="padding-left:2px;">'.$rowu[0].'</td><td align="center" style="padding-left:10px; width:30px;">'.$rowliste[1].'</td><td align="center" style="padding-left:10px; width:30px;">'.$rowliste[2].'</td><td align="right" style="padding-right:2px;">'.$rowliste[3].'</td></tr>';
			//<i class="fa '.$seymbol.' fa-2x" ></i>
  		$as++;
		}
	
		echo $sonuc;
	}
if ($ACTION == 'durumkontrol')
	{
		
	$stmtlisteler="SELECT list_id from vicidial_lists where campaign_id='$campaing';";
	$rsltlisteler=mysql_to_mysqli($stmtlisteler, $link);
	$listesayisi = mysqli_num_rows($rsltlisteler);	
	$as=0;
	$listesql='';
	$listesql="AND list_id in(";
	while ($as<$listesayisi) 
		{
  			$rowliste=mysqli_fetch_row($rsltlisteler);
	...
	$stmt="SELECT status, user from vicidial_list where phone_number='$phone_number' $listesql;";
	$rslt=mysql_to_mysqli($stmt, $link);
	$vla_records = mysqli_num_rows($rslt);
	if ($vla_records > 0) 
		{
		$rowx=mysqli_fetch_row($rslt);
		$musteri_durum = $rowx[0];
		$musteriarayankisi=$rowx[1];
		
		   if(($musteri_durum=="SALE" || $musteri_durum=="CBHOLD" || $musteri_durum=="CALLBK"))
		   {
			   $durum="";
		   }
		   else
...
if ($ACTION == 'musterisorgula')
	...
	#		$INFOout .= "<tr bgcolor=white><td ALIGN=right><font class='sb_text'>Entry List ID: &nbsp; </td><td ALIGN=left><font class='sb_text'>$row[28]</td></tr>";
		...
		if ($hide_call_log_info=='N')
			{
			if ($search != 'logfirst')
				{$NOTESout .= "<CENTER>"._QXZ("MÜŞTERİ ÇAĞRI GEÇMİŞİ:")."<br>\n";}
			$NOTESout .= "<TABLE CELLPADDING=0 CELLSPACING=1 BORDER=0 WIDTH=90%>";
			$NOTESout .= "<TR>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:10px;font-family:sans-serif;\"><B> &nbsp; # &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TARİH")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("PERSONEL")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("SÜRE")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("İŞLEM")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TELEFON")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("KAMPANYA")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("GELEN/GİDEN")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ARAMA")." &nbsp; </font></TD>";
			$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\"><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("KAPATAN")." &nbsp; </font></TD>";
		#	$NOTESout .= "</TR><TR>";
		#	$NOTESout .= "<TD BGCOLOR=\"#CCCCCC\" COLSPAN=9><font style=\"font-size:11px;font-family:sans-serif;\"><B> &nbsp; FULL NAME &nbsp; </font></TD>";
			$NOTESout .= "</TR>";
			...
			while ($g > $u) 
				...
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLlength_in_sec[$i]</td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLstatus[$i]</td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $phone_number_display </td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLcampaign_id[$i] </td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLin_out[$i] </td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLalt_dial[$i] </td>\n";
				$NOTESout .= "<td align=right><font class='sb_text'> $ALLhangup_reason[$i] </td>\n";
				...
				$NOTESout .= "<tr bgcolor=\"#CCCCCC\">";
				$NOTESout .= "<td COLSPAN=10 align=right height=50px>";
				$NOTESout .= '<a href="#" onClick="hideDiv(\'musterisorgu\');return false;" class="btn-ass">KAPAT<i class="fa fa-times" aria-hidden="true"></i></a></td></tr>';
...
if ($ACTION == 'AGENTtimeREPORT')
	...
	if ($stage == 'DISABLED')
		{
		echo "<BR><BR>\n";
		echo "<B>" . _QXZ("Hata: bu Özellik bu kampanya için devre dışı bırakıldı") . "</B>\n";
		echo "<BR><BR>\n";
		echo "<a href=\"#\" onclick=\"AgentTimeReport('close');return false;\">"._QXZ("Raporu Kapat")."</a>";
		}
	else
		{
		...
		if ($stage == 'ENABLED_BASIC')
			...
			echo "<TR>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("GÜNLÜK ZAMAN RAPORU")." &nbsp; </font></TD>";
			echo "</TR><TR>";
		...
		if ($stage == 'ENABLED_FULL')
			...
			echo "<TR>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("Anmeldezeit")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("Warten")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("Sprechen")." &nbsp; </font></TD>";
		...
		if ($stage == 'ENABLED_BILL_BREAK_LUNCH_COACH')
			...
			echo "<TR>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("FATURALANDIRILAN")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("ARA")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("YEMEK")." &nbsp; </font></TD>";
			echo "<TD BGCOLOR='white'><font style=\"font-size:14px;font-family:sans-serif;\"><B> &nbsp; "._QXZ("TOPLANTI")." &nbsp; </font></TD>";
			echo "</TR><TR>";
